...
class NotificationsActivity : AppCompatActivity() {
    ...
    private fun networkCheck(){
        ...
        lifecycleScope.launch{
            networkConnection.observe(this@NotificationsActivity, Observer{ isConnected->
                if(isConnected){
                    Log.d("Network Check", "OK")
                }

                else{
                    val mAlerDiaglog = MaterialAlertDialogBuilder(this@NotificationsActivity)
            ...
            authListener = object : FirebaseAuth.AuthStateListener{
                override fun onAuthStateChanged(p0: FirebaseAuth) {
                    ...
                    user?.let {
                        ...
                        val intent = Intent(this@NotificationsActivity, LoginActivity::class.java)
